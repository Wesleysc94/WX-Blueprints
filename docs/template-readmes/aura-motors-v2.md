...
Showroom automotivo dark-premium com hero cinematográfico e inventário filtrável.
...
**Deploy:** https://aura-motors-v2.vercel.app/
...
```bash
git clone https://github.com/Wesleysc94/Aura-Motors-V2-Blueprint-WX.git
cd Aura-Motors-V2-Blueprint-WX
...
👉 **https://wxblueprints.com/blueprints/aura-motors-v2**

Resumo rápido do que alterar:

1. **Cores** — edite as CSS vars em `src/styles/globals.css` (ou equivalente)
2. **Fontes** — Bebas Neue para títulos, Plus Jakarta Sans para corpo
...
Copie o prompt universal completo em [WX Blueprints — Aura Motors V2](https://wxblueprints.com/blueprints/aura-motors-v2) e cole em:
...
- **Blueprint técnico completo:** https://wxblueprints.com/blueprints/aura-motors-v2
- **Demo ao vivo:** https://aura-motors-v2.vercel.app/
