...
Showroom institucional com acabamento luxo e tom editorial.
...
**Deploy:** https://auramotors-v1.vercel.app/
...
```bash
git clone https://github.com/Wesleysc94/Aura-Motors-V1-Blueprint-WX.git
cd Aura-Motors-V1-Blueprint-WX
...
👉 **https://wxblueprints.com/blueprints/aura-motors-v1**

Resumo rápido do que alterar:

1. **Cores** — edite as CSS vars em `src/styles/globals.css` (ou equivalente)
2. **Fontes** — Playfair Display para títulos, Inter para corpo
...
Copie o prompt universal completo em [WX Blueprints — Aura Motors V1](https://wxblueprints.com/blueprints/aura-motors-v1) e cole em:
...
- **Blueprint técnico completo:** https://wxblueprints.com/blueprints/aura-motors-v1
- **Demo ao vivo:** https://auramotors-v1.vercel.app/
