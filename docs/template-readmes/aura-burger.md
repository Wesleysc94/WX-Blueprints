...
**Deploy:** https://aura-burger.vercel.app/
...
```bash
git clone https://github.com/Wesleysc94/Aura-Burger-Blueprint-WX.git
cd Aura-Burger-Blueprint-WX
...
2. **Fontes** — Oswald para títulos, Barlow para corpo
