...
Clínica veterinária premium com identidade moderna e conversiva.
...
**Deploy:** https://aura-veterinaria-premium.vercel.app/
...
```bash
git clone https://github.com/Wesleysc94/Aura-Veterin-ria-Blueprint-WX.git
cd Aura-Veterin-ria-Blueprint-WX
...
👉 **https://wxblueprints.com/blueprints/aura-veterinaria**

Resumo rápido do que alterar:

1. **Cores** — edite as CSS vars em `src/styles/globals.css` (ou equivalente)
2. **Fontes** — Outfit para títulos, Manrope para corpo
...
Copie o prompt universal completo em [WX Blueprints — Aura Veterinária](https://wxblueprints.com/blueprints/aura-veterinaria) e cole em:
...
- **Blueprint técnico completo:** https://wxblueprints.com/blueprints/aura-veterinaria
- **Demo ao vivo:** https://aura-veterinaria-premium.vercel.app/
